...
2 - O gestor de marketing pediu a lista das funcionárias que trabalhem no departamento de filmes OU no departamento lar.
    Ele necessita enviar um email para os colaboradores desses dois setores.
